  ...
  return (
    <>
      <Jumbotron>
        <Container>
          <Row>
            ...
            <Grid md={6}>
              <Holder ml='auto' md_mt='5rem' md_width='50%' mt='0.8rem'>
                <Link to='/login'>
                  <Button marginBottom='10px' background='#3f51b5;'>
                    <Icon mr='0.25rem' className='fas fa-sign-in-alt' />
                    Login
                  </Button>
                </Link>
                <Link to='/signup'>
                  <Button marginBottom='10px' background='#3f51b5;'>
                    <Icon className='far fa-envelope'></Icon> Sign Up with Email
                  </Button>
                </Link>
                <Link to='/'>
                  <Button marginBottom='10px' background='#3f51b5'>
                ...
                <Link to='/'>
                  <Button marginBottom='10px' background='#e84118'>
                    <Icon className='fab fa-google-plus-g'></Icon> google
                  </Button>
                </Link>
              </Holder>
            </Grid>
      ...
      <Container mb='2rem'>
        <Row>
          <Grid md={12} center>
            <TitleTwo padding='1.5rem'>What is Lorem Ipsum?</TitleTwo>
